...
#### Workspace
> Gitpod - For writing the code and building the website.
>
...
### Existing Features
> - Designed using HTML5, Bootstrap and CSS3
> - Multi-page website with a 5 sections on the index.html
> - Responsive navigation bar with smooth scrolling
> - Multiple call to action buttons
> - A sign up modal with radio styled as a buttons
> - Terms and conditions page that brings you to a new tab when you click the link
> - A scrolling carousel showing different freelancers and previous projects
> - Box shadow used throughout to give certain elements a sense of depth.

### Features to implement in the future
> - Sign form button need to be functional once I learn the correct languages
> - Project advertise page where clients can post projects they want completed so freelancers can bid on said project.

--- 

## Testing
> - Tested on Moto G4, Galaxy S5, Pixel 2, Pixel 2 XL, Iphone 5/SE, Iphone 6/7/8, Iphone 6/7/8 plus, Iphone X, Ipad, Ipad pro, Surface Duo and Galaxy fold.
> - Tested all the nav-links to make sure it brought me to the correct section or page.
> - Tested all buttons to make sure they also worked (Only the form submit button on the join-us modal does not work until I learn the required languages)
